...
const Insurance = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <Modal title="Insure your loved pet today !" footer={null} onCancel={() => setModalOpen(false)} onClose={() => setModalOpen(false)} open={modalOpen} >
        <Form
          form={form}
          layout="vertical"
        ...
        >
          ...
          >
            <Input placeholder="Enter Pet Category" />
          </Form.Item>
          <Form.Item
            label="Pet Breed"
            name="breed"
      ...
      <div>
        ...
        <div className='w-full flex justify-end' >
          <Button
            ...
            type="primary"
            className='bg-[#FFDDCC] text-black p-7 absolute bottom-40 left-[300px]'
